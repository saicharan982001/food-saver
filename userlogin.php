...
<h1 class="text tect-capitalize text-center text-primary">User Login</h1>
<form method="post">
<div>
<table align="center">
    <tr><td>Email:</td>
    ...
    <tr><td>Password:</td><td>
        ...
        <td><input type="submit" name="login" value="Login" class="btn btn-danger" style="background-color:#FCD34D;border:1px" style="margin-left: 30px">
